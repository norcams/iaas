...
1. As long ad the disks do not use the same kernel disk driver we can set the
...
2. If the disks use the same kernel driver you will need to use the :file:`wwn`
